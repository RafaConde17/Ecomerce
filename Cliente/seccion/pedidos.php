...
<?php  include $_SERVER['DOCUMENT_ROOT']."/Ecomerce/Cliente/seccion/modal_cliente.php"; ?>
<?php  include $_SERVER['DOCUMENT_ROOT']."/Ecomerce/Cliente/seccion/modal_pedido.php"; ?>
