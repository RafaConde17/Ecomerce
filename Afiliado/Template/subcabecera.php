                 ...
                 <li  class="nav-item">
                    ...
                    <li tyle="color: white;">
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu3" data-bs-parent="#menu">
                            <li class="w-100">
                            <a href="productos.php" class="nav-link px-0"> <span class="d-none d-sm-inline" style="margin-left: 20px;"></span> Productos</a>
                          </li>
                        </ul>
                    </li> 
                    ...
                    <li tyle="color: white;">
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu4" data-bs-parent="#menu">
                            <li class="w-100">
                            <a href="contactar.php" class="nav-link px-0"> <span class="d-none d-sm-inline" style="margin-left: 20px;"></span> Contactar</a>
                          </li>
                        
                        </ul>
                    </li>
                    <li>
                        <a style="color: white;" href="salir.php" class="nav-link px-0 align-middle">
