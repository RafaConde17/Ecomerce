...
$(document).ready(function() { 
                   ...
                   rutaprueba= "../../Arv_ajax/ajax_ingresar_img.php";

                    if(validateImage(rutaprueba)){
                     // alert("existe");
                    }else{
                    //   alert("no existe");
                    ...
                    $('.Cancelardatos').click(function () {
                        ...
                        {
                            var idusuario = $(this).attr('referencia');
                        ...
                        $('.Guardardatos').click(function () {
                            ...
                            var productoid = document.getElementById('txtID').value;
                                                    ...
                                                    if(resultado.resultado =="Registro Modificado"){
                                                        ...
                                                        if(imagen.length > 0){
                                                                    ...
                                                                    fetch('../../Arv_ajax/ajax_reemplazar_img.php', {
                                                                        ...
                                                                        document.getElementById("modal_imagen").src = "../"+ imagenruta + img;
                                                                        habilitado = true;
                                                                        habilitarBotones();
