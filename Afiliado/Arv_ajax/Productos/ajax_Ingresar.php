...
if (!empty($_POST) && isset($_POST['action']) && $_POST['action'] == 'ingresar') {
    ...
    $sentenciaSQL->bindParam(':dato1', $producto);
    $sentenciaSQL->bindParam(':dato2', $idusuario);
    $sentenciaSQL->bindParam(':dato3', $idcategoria);
    $sentenciaSQL->bindParam(':dato4', $subcategoria);
    $sentenciaSQL->bindParam(':dato5', $descripcion);
    $sentenciaSQL->bindParam(':dato6', $cantidad);
    $sentenciaSQL->bindParam(':dato7', $precio);
    $sentenciaSQL->bindParam(':dato8', $imagen);
    $sentenciaSQL->bindParam(':dato9', $estado);
    $sentenciaSQL->execute();
