...
<script src="https://code.jquery.com/jquery-3.5.1.min.js" integrity="sha384-ZvpUoO/+PpLXR1lu4jmpXWu80pZlYUAfxl5NsBMWOEPSjUn/6Z/hRTt8+pR6L4N2" crossorigin="anonymous"></script>
  <!-- Popper.JS -->
    ...
    <script src="../../JS/Perfil_index_sub.js"></script>
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li tyle="color: white;">
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
                            <li class="w-100">
                            <a href="medio_envio.php" class="nav-link px-0"> <span class="d-none d-sm-inline" style="margin-left: 20px;"></span> Medio envió</a>
                            </li>
                    ...
                    <li tyle="color: white;">
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu3" data-bs-parent="#menu">
                          <li class="w-100">
                            <a href="usuarios.php" class="nav-link px-0"> <span class="d-none d-sm-inline" style="margin-left: 20px;"></span>Adm. Usuario</a>
                            <a href="tipo_usuario.php" class="nav-link px-0"> <span class="d-none d-sm-inline" style="margin-left: 20px;"></span>Tipo Usuario</a>
                    ...
                    <li tyle="color: white;">
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu4" data-bs-parent="#menu">
                            <li class="w-100">
                            <a href="productos.php" class="nav-link px-0"> <span class="d-none d-sm-inline" style="margin-left: 20px;"></span> Reg Producto</a>
                            <a href="categoria_producto.php" class="nav-link px-0"> <span class="d-none d-sm-inline" style="margin-left: 20px;"></span> Reg categoria</a>
                          </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a style="color: white;" href="cerrar.php" class="nav-link px-0 align-middle">
