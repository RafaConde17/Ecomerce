                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li tyle="color: white;">
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu3" data-bs-parent="#menu">
                          <li class="w-100">
                            <a href="seccion/usuarios.php" class="nav-link px-0"> <span class="d-none d-sm-inline" style="margin-left: 20px;"></span>Adm. Usuario</a>
                            <a href="seccion/tipo_usuario.php" class="nav-link px-0"> <span class="d-none d-sm-inline" style="margin-left: 20px;"></span>Tipo Usuario</a>
                    ...
                    <li tyle="color: white;">
                        ...
                        <ul class="collapse nav flex-column ms-1" id="submenu4" data-bs-parent="#menu">
                            <li class="w-100">
                            <a href="seccion/productos.php" class="nav-link px-0"> <span class="d-none d-sm-inline" style="margin-left: 20px;"></span> Reg Producto</a>
                            <a href="seccion/categoria_producto.php" class="nav-link px-0"> <span class="d-none d-sm-inline" style="margin-left: 20px;"></span> Reg categoria</a>
                          </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a style="color: white;" href="seccion/cerrar.php" class="nav-link px-0 align-middle">
